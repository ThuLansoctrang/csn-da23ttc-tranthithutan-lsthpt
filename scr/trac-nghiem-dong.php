...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .feedback{ border-color: rgba(40, 167, 69, .45);color: var(--ok);background: rgba(40, 167, 69, .06);margin-top:12px;padding:12px;border-radius:14px;border:1px dashed rgba(29,53,87,.18);border-color: rgba(5, 188, 48, 1);;font-weight:700;font-size:15px;color:var(--muted);line-height:1.6}
    ...
    .explain{margin-top:12px;border-top:1px dashed rgba(29,53,87,.18);padding-top:12px;color:#15952d;font-weight:700;line-height:1.7}
    .explain strong{color:#0da710}
  </style>
</head>
...
<script>
  ...
  function checkCurrent(){
    const s = state[current];
    if(s.selected === null){
      feedback.innerHTML = " Chưa chọn mà đòi kiểm tra? Chọn đi nào!!!";
      return;
    }
    s.locked = true;
